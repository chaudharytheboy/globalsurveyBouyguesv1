...
<div class="container-fluid">
  <div class="row">
  <div class="col" style='text-align:center;background-color:#009dcc;color:#fff;margin-top:1rem;  padding:2px;letter-spacing:1px;font-family:roboto'> 
        <a href="logout.php" class="btn" style="float:right;margin-top:10px;margin-right:1rem;background-color:white;color:black;letter-spacing:1px">Logout</a>
