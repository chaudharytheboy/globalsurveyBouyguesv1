...
//print_r($data);exit;
?>
<div class="col" style='text-align:center;background-color:#009dcc;color:#fff;padding:2px;margin-top:1rem;letter-spacing:1px;font-family:roboto'>
    ...
    <div class='col-sm-6 col-sm-offset-3'>
      <form method="POST" action="" enctype = 'multipart/form-data' id="submitData">
        ...
        <div class="form-group">
          ...
          <img src="../<?php echo $data['images'];?>" width="100px;" id = "globalbouygues">
          <input type="file"  name="images" onchange = Bouygues(this);>
        ...
        <div class="form-group">
                    <label for="exampleInputPassword1">Most Popular / Top Rated / Best Offer Image Uploaded
                        For</label><br />
                    <img src="../<?php echo $data['img_popular'];?>" width="100px;" id = "globalbouyguespop">
                    <input type="file" name="img_popular" onchange = Bouyguespopimg(this);>

                </div>
       
        <button type="submit" class="btn btn-primary" name="update" style="width:100%">Submit</button>
      </form>
         </div>
